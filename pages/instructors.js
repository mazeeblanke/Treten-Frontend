    ...
    return (
      <>
        <section className="meet-the-instructors mt-2 pb-2">
          <h3 className="text-center instructors__main-text pt-5">Meet our Instructors</h3>
            ...
            <div className="row justify-content-center">
              <div className="col-md-6">
                <p className="text-center instructors__sub-text pb-4">
                  ...
                  years of experience but are also amongst the top 60,000+ recognized CCIE experts
                  across the globe.
                </p>
              </div>
            </div>
