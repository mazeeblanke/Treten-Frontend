...
class Blog extends Component {
  ...
  render () {
    return (
      <>
        <section style={{ background: 'linear-gradient(0deg, rgba(115, 115, 115, 0.3), rgba(0, 0, 0, 0.68)), url(/static/images/blogpost.png)', height: '300px' }}>
          <div className="d-flex flex-column justify-content-center has-full-height">
            ...
            <p className="text-center is-smokewhite">
            ...
            <div className="row justify-content-center">
              <div className="col-md-8 col-sm-12">
                ...
                <p>
                  ...
                  two ghostly white figures in coveralls and helmets are soflty dancing made in the interiors of collapsing stars
                  stirred by starlight star stuff harvesting star light.
                </p>
                ...
                <p>
                  ...
                  sword the sky calls to us star stuff harvesting star light. Hearts of the stars with pretty stories for which there's
                  little good evidence globular star cluster muse about shores of the cosmic ocean the ash of stellar alchemy.
                </p>

                <p>
                  Vangelis tingling of the spine worldlets billions upon billions stirred by starlight two ghostly
                  white figures in coveralls and helmets are soflty dancing. At the edge of forever great turbulent
                  clouds a mote of dust suspended in a sunbeam corpus callosum at the edge of forever great turbulent
                  clouds? How far away Sea of Tranquility dispassionate extraterrestrial observer extraordinary claims
                  require extraordinary evidence great turbulent clouds great turbulent clouds?
                  ...
                  Not a sunrise but a galaxyrise citizens of distant epochs astonishment courage of our questions invent the universe
                ...
                <a className="related-link mb-4 pb-1">My dad once told me, laugh and the world laughs with you</a>
                <br />
                <br />
                <a className="related-link pb-1">My dad once told me, laugh and the world laughs with you</a>
