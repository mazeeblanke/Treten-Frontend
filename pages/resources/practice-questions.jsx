            ...
            <div className="row justify-content-center mb-5">
              <div className="col-md-5 pl-5 pr-5">
                <p className="lh-30 fs-16 text-center">
                  Stay ahead and prepare for your professional exams with our free practice questions.
                </p>
              </div>
            </div>
          </div>
        </section>
        <section className="practice-questions has-white-bg pt-4 mb-8">
          <div className="container">
            ...
            <div className="row mt-6">
              ...
              {
                this.state.PracticeQuestion.map((interviewQuestion) => (
                    ...
                    <div className="card border-0">
                      <div className="card-body">
                        ...
                        <p className="mt-2">
                          ...
                          <img alt="download" src="/images/arrow-right.png" />
                        </p>
                      </div>
                    </div>
                  </div>
...
export default connect(mapStateToProps, actions)(withMasterLayout(PracticeQuestion))
