...
export default function (state = INITIAL_STATE, { type, payload }) {
  ...
  switch (type) {
    case `SET_INSTRUCTOR_LOADING_${category}_COURSES`: {
      return {
        ...state,
        [payload.category]: {
    ...
    case `SET_INSTRUCTOR_${category}_COURSES`: {
...
export const getAllInstructorCourses = state => {
  const { all } = state.instructorCourses
...
// export const getSortDirection = (state, tab) => {
