export const ROUTES = {
  ADMIN_DASHBOARD_TESTIMONIALS: '/d/admin/testimonials/listings',
  ADMIN_DASHBOARD_CERTIFICATIONS: '/d/admin/certifications/listings',
  ADMIN_DASHBOARD_COURSEPATHS: '/d/admin/course-paths/listings',
  ADMIN_DASHBOARD_TEAM: '/d/admin/team/listings',
  ADMIN_DASHBOARD_BLOGS: '/d/admin/blog-posts/listings',
