          ...
          <div className="col-md-12 mb-1">
            <Form.Item>
              ...
              {getFieldDecorator('course', {
                ...
                <Select onChange={(e) => {this.props.setEmailForm({ name: 'course', value: e})}} size="large" placeholder="Select user group" className="has-full-width">
          ...
          <div className="col-md-12 mb-1">
            <Form.Item>
              ...
              {getFieldDecorator('title', {
                ...
                initialValue: this.props.emailForm.title
              })(
                <Input
                  allowClear
                  size="large"
                  ...
                  onChange={(e) => {this.props.setEmailForm({ name: 'title', value: e.target.value })}}
                />
              )}
            </Form.Item>
          </div>
                    ...
                    : (
                      <div className="text-center">
                        <div className="d-flex justify-content-center align-items-center">
                          <p className="m-0 p-0">{this.props.emailForm.file.name}</p>
                        </div>
                        <small onClick={(e) => this.props.setEmailForm({ name: 'file', value: e[0] })} style={{ color: '#e12828' }}>remove file</small>
                      </div>
                    )
                }
              </div>
