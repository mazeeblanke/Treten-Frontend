...
(function (factory) {
  ...
  Slick.prototype.checkResponsive = function (initial, forceUpdate) {
    const _ = this
    let breakpoint; let targetBreakpoint; let respondToWidth; let
  ...
  Slick.prototype.changeSlide = function (event, dontAnimate) {
    ...
    let indexOffset; let slideOffset; let
      unevenOffset
  ...
  Slick.prototype.getSlideCount = function () {
    const _ = this
    let slidesTraversed; let swipedSlide; let
      centerOffset

    centerOffset = _.options.centerMode === true ? _.slideWidth * Math.floor(_.options.slidesToShow / 2) : 0

    if (_.options.swipeToSlide === true) {
      _.$slideTrack.find('.slick-slide').each((index, slide) => {
  ...
  Slick.prototype.initADA = function () {
    const _ = this
    const numDotGroups = Math.ceil(_.slideCount / _.options.slidesToShow)
    const tabControlIndexes = _.getNavigableIndexes().filter((val) => (val >= 0) && (val < _.slideCount))
  ...
  Slick.prototype.lazyLoad = function () {
    const _ = this
    let loadRange; let cloneRange; let rangeStart; let
      rangeEnd
    ...
    if (_.options.lazyLoad === 'anticipated') {
      ...
      const $slides = _.$slider.find('.slick-slide')
  ...
  Slick.prototype.refresh = function (initializing) {
    const _ = this; let currentSlide; let
      lastVisibleIndex
  ...
  Slick.prototype.setOption = Slick.prototype.slickSetOption = function () {
    ...
    const _ = this; let l; let item; let option; let value; let refresh = false; let
      type
  ...
  Slick.prototype.setSlideClasses = function (index) {
    const _ = this
    let centerOffset; let allSlides; let indexOffset; let
      remainder
  ...
  Slick.prototype.swipeDirection = function () {
    let xDist; let yDist; let r; let swipeAngle; const
      _ = this
  ...
  Slick.prototype.swipeMove = function (event) {
    ...
    let curLeft; let swipeDirection; let swipeLength; let positionOffset; let touches; let
      verticalSwipeLength
